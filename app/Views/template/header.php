                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                ...
                                                <div class="message-menu">
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="<?php echo base_url('template') ?>/assets/images/users/1.jpg"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="<?php echo base_url('template') ?>/assets/images/users/15.jpg"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="<?php echo base_url('template') ?>/assets/images/users/12.jpg"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="<?php echo base_url('template') ?>/assets/images/users/4.jpg"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
