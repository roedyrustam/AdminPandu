                ...
                <div class="tab-pane" id="side2">
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="<?php echo base_url('template') ?>/assets/images/users/2.jpg"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="<?php echo base_url('template') ?>/assets/images/users/11.jpg"><span class="avatar-status bg-success"></span></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="<?php echo base_url('template') ?>/assets/images/users/10.jpg"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="<?php echo base_url('template') ?>/assets/images/users/13.jpg"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="<?php echo base_url('template') ?>/assets/images/users/12.jpg"><span class="avatar-status bg-success"></span></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="<?php echo base_url('template') ?>/assets/images/users/15.jpg"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="<?php echo base_url('template') ?>/assets/images/users/4.jpg"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="<?php echo base_url('template') ?>/assets/images/users/7.jpg"><span class="avatar-status bg-success"></span></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="<?php echo base_url('template') ?>/assets/images/users/9.jpg"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="<?php echo base_url('template') ?>/assets/images/users/2.jpg"><span class="avatar-status bg-success"></span></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                                    <div class="fw-semibold text-dark" data-bs-toggle="modal" data-target="#chatmodel">Addie Minstra</div>
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="<?php echo base_url('template') ?>/assets/images/users/14.jpg"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="<?php echo base_url('template') ?>/assets/images/users/11.jpg"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image" data-bs-image-src="<?php echo base_url('template') ?>/assets/images/users/4.jpg"><span class="avatar-status bg-success"></span></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                                    <div class="fw-semibold text-dark" data-bs-toggle="modal" data-target="#chatmodel">Cherry Blossom</div>
                ...
                <ul class="row p-3">
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block active">
                            <span class="country-selector"><img alt="" src="<?php echo base_url('template') ?>/assets/images/flags/us_flag.jpg" class="me-3 language"></span>USA
                        </a>
                    </li>
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt="" src="<?php echo base_url('template') ?>/assets/images/flags/italy_flag.jpg" class="me-3 language"></span>Italy
                        </a>
                    </li>
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt="" src="<?php echo base_url('template') ?>/assets/images/flags/spain_flag.jpg" class="me-3 language"></span>Spain
                        </a>
                    </li>
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt="" src="<?php echo base_url('template') ?>/assets/images/flags/india_flag.jpg" class="me-3 language"></span>India
                        </a>
                    </li>
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt="" src="<?php echo base_url('template') ?>/assets/images/flags/french_flag.jpg" class="me-3 language"></span>French
                        </a>
                    </li>
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt="" src="<?php echo base_url('template') ?>/assets/images/flags/russia_flag.jpg" class="me-3 language"></span>Russia
                        </a>
                    </li>
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt="" src="<?php echo base_url('template') ?>/assets/images/flags/germany_flag.jpg" class="me-3 language"></span>Germany
                        </a>
                    </li>
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt="" src="<?php echo base_url('template') ?>/assets/images/flags/argentina.jpg" class="me-3 language"></span>Argentina
                        </a>
                    </li>
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt="" src="<?php echo base_url('template') ?>/assets/images/flags/malaysia.jpg" class="me-3 language"></span>Malaysia
                        </a>
                    </li>
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt="" src="<?php echo base_url('template') ?>/assets/images/flags/turkey.jpg" class="me-3 language"></span>Turkey
                        </a>
                    </li>
                </ul>
            </div>
...
<!-- PIETY CHART JS-->
<script src="<?php echo base_url('template') ?>/assets/plugins/peitychart/jquery.peity.min.js"></script>
<script src="<?php echo base_url('template') ?>/assets/plugins/peitychart/peitychart.init.js"></script>
...
<script src="<?php echo base_url('template') ?>/assets/plugins/chart/Chart.bundle.js"></script>
<script src="<?php echo base_url('template') ?>/assets/plugins/chart/rounded-barchart.js"></script>
<script src="<?php echo base_url('template') ?>/assets/plugins/chart/utils.js"></script>

<!-- INTERNAL SELECT2 JS -->
<script src="<?php echo base_url('template') ?>/assets/plugins/select2/select2.full.min.js"></script>

<!-- INTERNAL Data tables js-->
<script src="<?php echo base_url('template') ?>/assets/plugins/datatable/js/jquery.dataTables.min.js"></script>
<script src="<?php echo base_url('template') ?>/assets/plugins/datatable/js/dataTables.bootstrap5.js"></script>
<script src="<?php echo base_url('template') ?>/assets/plugins/datatable/dataTables.responsive.min.js"></script>

<!-- INTERNAL APEXCHART JS -->
<script src="<?php echo base_url('template') ?>/assets/js/apexcharts.js"></script>
<script src="<?php echo base_url('template') ?>/assets/plugins/apexchart/irregular-data-series.js"></script>

<!-- C3 CHART JS -->
<script src="<?php echo base_url('template') ?>/assets/plugins/charts-c3/d3.v5.min.js"></script>
<script src="<?php echo base_url('template') ?>/assets/plugins/charts-c3/c3-chart.js"></script>

<!-- CHART-DONUT JS -->
<script src="<?php echo base_url('template') ?>/assets/js/charts.js"></script>

<!-- INTERNAL Flot JS -->
<script src="<?php echo base_url('template') ?>/assets/plugins/flot/jquery.flot.js"></script>
<script src="<?php echo base_url('template') ?>/assets/plugins/flot/jquery.flot.fillbetween.js"></script>
<script src="<?php echo base_url('template') ?>/assets/plugins/flot/chart.flot.sampledata.js"></script>
<script src="<?php echo base_url('template') ?>/assets/plugins/flot/dashboard.sampledata.js"></script>

<!-- INTERNAL Vector js -->
<script src="<?php echo base_url('template') ?>/assets/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
<script src="<?php echo base_url('template') ?>/assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

<!-- SIDE-MENU JS-->
<script src="<?php echo base_url('template') ?>/assets/plugins/sidemenu/sidemenu.js"></script>

<!-- INTERNAL INDEX JS -->
<script src="<?php echo base_url('template') ?>/assets/js/index1.js"></script>
